...
export default function Auth() {
  ...
  const { isloading, error, login, details } = useAppSelector((state) => state.auth);
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollview} showsVerticalScrollIndicator={false}>
        ...
        <TextInput
          ...
          style={styles.input}
        />
        <Button title={isloading ? "Processing..." : "Sign In"} onPress={signInWithEmail} />
        <TouchableOpacity onPress={() => router.push("/(auth)/emailPasswordsignUp")} style={styles.touchableOpacity}>
